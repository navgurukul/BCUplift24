...
class TransactionManagerTest {
    ...
    void setUp() {
        ...
        when(random.nextInt(1000, 10000)).thenReturn(RANDOM_NUMBER);
    ...
    @Test
    void makePayment() throws InsufficientAccountBalanceException, InvailidOfpException, OtpExpiredException {
    ...
    @Test
    void makePaymentThrowInvailidOtpEception() throws OtpExpiredException {
        when(otpManager.validateOtp()).thenReturn(false);
        assertThrows(InvailidOfpException.class, ()->tm.makePayment(ACCOUNT_NUMBER, TransferType.ACCOUNT_ID, MOBILE_NUMBER,TransferType.MOBILE,  1045.0));
    }
}